import matplotlib
matplotlib.use('Agg')  # Set the backend to non-interactive 'Agg' before any other matplotlib imports
...
class PlotGenerator:
    ...
    def generate_plots(self, data: pd.DataFrame) -> Optional[datetime]:
        ...
        try:
            ...
            system_metrics = ["hours", "active", "modulation", "starts", "solar_production", "solar_pump"]
            sns.lineplot(
            ...
            temps = ["temp_boiler", "temp_hotwater", "temp_hotwater_target",
                    "temp_solcollector", "temp_solstorage"]
